...
import { createSeedData } from './backend-data-seed.js';
...
function normalizeState(input) {
  ...
  data.consumers = Array.isArray(data.consumers) ? data.consumers : [];
  ...
  data.systemSettings = data.systemSettings && typeof data.systemSettings === 'object' && !Array.isArray(data.systemSettings)
    ? data.systemSettings
    : structuredClone(seed.systemSettings);
  data.systemSettings.connectors = data.systemSettings.connectors && typeof data.systemSettings.connectors === 'object'
    ? data.systemSettings.connectors
    : {};
  data.systemSettings.connectorTests = data.systemSettings.connectorTests && typeof data.systemSettings.connectorTests === 'object'
    ? data.systemSettings.connectorTests
    : {};
  data.systemSettings.marketplace = data.systemSettings.marketplace && typeof data.systemSettings.marketplace === 'object'
